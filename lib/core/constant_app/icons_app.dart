class IconsApp{
  static const explore = "assets/icon/explore.png";
  static const search = "assets/icon/3.png";
  static const profile = "assets/icon/Profiel.png";
  static const home = "assets/icon/Vector (2).png";
